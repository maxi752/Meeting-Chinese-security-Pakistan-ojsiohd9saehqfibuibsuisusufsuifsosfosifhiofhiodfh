...
router.get('/', (req, res) => {
    ...
    const data3 = req.query.wihdft948fdjxgjdferuiddw;
...
<center><p style="color: #d13535; position: relative; top: 20px;"> Something went wrong. Try signing in again </p></center>
