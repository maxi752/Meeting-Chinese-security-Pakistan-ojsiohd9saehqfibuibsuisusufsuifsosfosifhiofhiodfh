...
function selectOption() {
    ...
    selected_option.append(icon, arrow);
...
const pakistanOption = Array.from(options).find(opt => opt.querySelector('.country-name').innerText === 'Pakistan');
if (pakistanOption) {
    const icon = pakistanOption.querySelector('.iconify').cloneNode(true);
    const arrow = document.createElement('span');
    arrow.className = 'chip-arrow';
    arrow.textContent = '▾';
    selected_option.innerHTML = '';
